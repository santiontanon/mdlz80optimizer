...
public class MDLConfig {
    ...
    public boolean tniasmPipeAsOr = false;
    ...
    public String docString = "MDL "+Main.VERSION_STRING+" (A Z80 assembler optimizer) by Santiago Ontañón (Brain Games, 2020-2024)\n"
            ...
            + "- ```-tniasm-pipe-as-or```: '|' is used as a statement separator in tniasm instead of as 'or'. If you use this flag, '|' is considered as 'or' instead. However, notice that this might lead to ambiguity in parsing if there is a line where '|' could be interpreted both ways.\n"
