...
public class PatternBasedOptimizerTest {
    ...
    @Test public void test17() throws IOException { Assert.assertEquals(5, test("data/tests/test17.asm")); }
    @Test public void test18() throws IOException { Assert.assertEquals(5, test("data/tests/test18.asm")); }
    ...
    @Test public void test25() throws IOException { Assert.assertEquals(0, test("data/tests/test25.asm")); }
    ...
    @Test public void test30() throws IOException { Assert.assertEquals(1, test("data/tests/test30.asm")); }
    @Test public void test31() throws IOException { Assert.assertEquals(4, test("data/tests/test31.asm")); }
    @Test public void test32() throws IOException { Assert.assertEquals(3, test("data/tests/test32.asm")); }
