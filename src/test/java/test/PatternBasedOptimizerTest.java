...
public class PatternBasedOptimizerTest {
    ...
    @Test public void test2() throws Exception { test("data/potests/test2.asm", null, null, "size",  6, 17, 17, "data/potests/test2-expected.asm"); }
    @Test public void test3() throws Exception { test("data/potests/test3.asm", null, null, "size",  2, 3, 3, "data/potests/test3-expected.asm"); }
    @Test public void test4() throws Exception { test("data/potests/test4.asm", null, null, "size",  1, -2, -2, "data/potests/test4-expected.asm"); }
    @Test public void test5() throws Exception { test("data/potests/test5.asm", null, null, "size",  3, 6, 6, "data/potests/test5-expected.asm"); }
    ...
    @Test public void test20() throws Exception { test("data/potests/test20.asm", null, null, "size",  8, 6, 16); }
    @Test public void test21() throws Exception { test("data/potests/test21.asm", null, null, "size",  10, 31, 31); }
    ...
    @Test public void test52() throws Exception { test("data/potests/test52.asm", null, null, "size",  3, 13, 13); }
    @Test public void test52sdcc() throws Exception { test("data/potests/test52sdcc.asm", "sdcc", null, "size",  1, 5, 5); }
    ...
    @Test public void test55() throws Exception { test("data/potests/test55.asm", null, null, "size",  3, 13, 13, null); }
    ...
    @Test public void test64() throws Exception { test("data/potests/test64.asm", null, null, "size",  2, 10, 10, "data/potests/test64-expected.asm"); }
    ...
    @Test public void test77() throws Exception { test("data/potests/test77.asm", "sdcc", null, "size", 4, 33, 33, "data/potests/test77-expected.asm"); }
    @Test public void test78() throws Exception { test("data/potests/test78.asm", "sdcc", null, "size", 3, 21, 21, "data/potests/test78-expected.asm"); }
    @Test public void test79() throws Exception { test("data/potests/test79.asm", null, null, "size", 13, -16, -16, "data/potests/test79-expected.asm"); }
    @Test public void test79a() throws Exception { test("data/potests/test79.asm", null, null, "speed", -2, 6, 6 , null); }
    @Test public void test80() throws Exception { test("data/potests/test80.asm", null, null, "size", 2, 11, 11, "data/potests/test80-expected.asm"); }
    @Test public void test81() throws Exception { test("data/potests/test81.asm", null, null, "size", 0, 0, 0, "data/potests/test81-expected.asm"); }
    @Test public void test82() throws Exception { test("data/potests/test82.asm", null, null, "size", 4, 18, 18, "data/potests/test82-expected.asm"); }
    @Test public void test83() throws Exception { test("data/potests/test83.asm", null, null, "size", 4, 20, 20, "data/potests/test83-expected.asm"); }
    @Test public void test84() throws Exception { test("data/potests/test84.asm", null, null, "size", 3, 15, 15, "data/potests/test84-expected.asm"); }
    @Test public void test85() throws Exception { test("data/potests/test85.asm", null, null, "size", 0, 0, 0, "data/potests/test85-expected.asm"); }
