...
public class BinaryGeneratorTest {
    ...
    @Test public void test18() throws Exception { Assert.assertTrue(test("data/generationtests/tniasm-10-4.asm", "tniasm10",
                                                                           "data/generationtests/tniasm-10-4-expected.bin")); }
