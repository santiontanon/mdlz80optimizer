...
public class SearchBasedOptimizerTest {
    ...
    @Test public void test1_3() throws IOException { test("data/searchtests/opt-test1.asm", "data/searchtests/opt-test1-expected-b3.asm", "ops", 3); }
    @Test public void test2() throws IOException { test("data/searchtests/opt-test2.asm", new String[]{"data/searchtests/opt-test2-expected.asm", "data/searchtests/opt-test2-expected2.asm"}); }
