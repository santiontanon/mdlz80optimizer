...
public class SearchBasedOptimizerTest {
    ...
    @Test public void test4() throws IOException { test("data/searchtests/opt-test4.asm", new String[]{"data/searchtests/opt-test4-expected.asm", "data/searchtests/opt-test4-expected2.asm"}); }
...
//              new String[]{"data/searchtests/opt-test16-expected.asm"}); }
    ...
    @Test public void test19() throws IOException { test("data/searchtests/opt-test19.asm", 
              new String[]{"data/searchtests/opt-test19-expected.asm"}); }
