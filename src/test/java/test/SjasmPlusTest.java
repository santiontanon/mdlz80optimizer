...
public class SjasmPlusTest {
    ...
    @Test public void test13() throws IOException { Assert.assertTrue(test("data/generationtests/sjasmplus-test13.asm",
                                                                          "data/generationtests/sjasmplus-test13-expected.asm")); }
